<template>
  ...
  >
    ...
    <div class="section-header">
      ...
      <span class="section-title">Dossier de déduction</span>
      <div class="section-line"></div>
    </div>
        ...
        <div class="card-header">
          ...
          <div class="card-status-icons">
            <span 
              ...
              title="Construction de graphiques"
            >◇</span>
            <span 
...
rapport d'analyse"
        ...
        <div class="card-files-wrapper">
          ...
          <div class="files-empty" v-else>
            ...
            <span class="empty-file-text">v</span>
          </div>
        </div>
          ...
          <div class="modal-content">
            ...
            <div class="modal-body">
              ...
              <div class="modal-section">
                <div class="modal-label">Exigences de simulation</div>
              ...
              <div class="modal-section">
                ...
                <div class="modal-empty" v-else>Aucun fichier associé disponible.</div>
              </div>
            </div>
            ...
            <div class="modal-divider">
              ...
              <span class="divider-text">Relecture de la déduction</span>
              <span class="divider-line"></span>
            </div>
            ...
            <div class="modal-actions">
              ...
              >
                ...
                <span class="btn-text">Construction de graphiques</span>
              </button>
              <button 
            ...
            <div class="modal-playback-hint">
              <span class="hint-text">Les étapes 3 « Démarrer la simulation » et 5 « Interaction approfondie » doivent être lancées pendant que le programme est en cours d’exécution et ne prennent pas en charge la lecture de l’historique.</span>
            </div>
          </div>
        </div>
      </Transition>
