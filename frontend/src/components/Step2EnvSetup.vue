      ...
      <div class="step-card" :class="{ 'active': phase === 0, 'completed': phase > 0 }">
        <div class="card-header">
          <div class="step-info">
            ...
            <span class="step-title">Initialisation de l'instance factice</span>
          </div>
          <div class="step-status">
            <span v-if="phase > 0" class="badge success">Complété</span>
        ...
        <div class="card-content">
          ...
          <div v-if="simulationId" class="info-card">
            ...
            <div class="info-row">
              ...
              <span class="info-value mono">{{ taskId || 'La tâche asynchrone est terminée.' }}</span>
            </div>
          </div>
        </div>
      </div>
      ...
      <div class="step-card" :class="{ 'active': phase === 1, 'completed': phase > 1 }">
        <div class="card-header">
          <div class="step-info">
            ...
            <span class="step-title">Générer un profil d'agent</span>
          </div>
          <div class="step-status">
            <span v-if="phase > 1" class="badge success">Complété</span>
        ...
        <div class="card-content">
          ...
          <div v-if="profiles.length > 0" class="stats-grid">
            <div class="stat-card">
              ...
              <span class="stat-label">Nombre actuel d'agents</span>
            </div>
            <div class="stat-card">
              <span class="stat-value">{{ expectedTotal || '-' }}</span>
              <span class="stat-label">Nombre total d'agents prévu</span>
            </div>
            <div class="stat-card">
      ...
      <div class="step-card" :class="{ 'active': phase === 2, 'completed': phase > 2 }">
        <div class="card-header">
          <div class="step-info">
            ...
            <span class="step-title">Générer une configuration de simulation double plateforme</span>
          </div>
          <div class="step-status">
            <span v-if="phase > 2" class="badge success">Complété</span>
            <span v-else-if="phase === 2" class="badge processing">Générateur</span>
            <span v-else class="badge pending">attendez</span>
          </div>
        </div>
        <div class="card-content">
          ...
          <div v-if="simulationConfig" class="config-detail-panel">
            ...
            <div class="config-block">
              ...
              <div class="time-periods">
                <div class="period-item">
                  <span class="period-label">heures de pointe</span>
                  <span class="period-hours">{{ simulationConfig.time_config?.peak_hours?.join(':00, ') }}:00</span>
                  <span class="period-multiplier">×{{ simulationConfig.time_config?.peak_activity_multiplier }}</span>
                </div>
                <div class="period-item">
                  <span class="period-label">heures de travail</span>
                  <span class="period-hours">{{ simulationConfig.time_config?.work_hours?.[0] }}:00-{{ simulationConfig.time_config?.work_hours?.slice(-1)[0] }}:00</span>
                  <span class="period-multiplier">×{{ simulationConfig.time_config?.work_activity_multiplier }}</span>
                </div>
                <div class="period-item">
                  <span class="period-label">séance du matin</span>
                  ...
                  <div class="agent-params">
                    <div class="param-group">
                      <div class="param-item">
                        <span class="param-label">Lors de la publication</span>
                    ...
                    <div class="param-group">
                      <div class="param-item">
                        <span class="param-label">Activité</span>
                      ...
                      <div class="param-item">
                        <span class="param-label">tendances émotionnelles</span>
            ...
            <div class="config-block">
              <div class="config-block-header">
                <span class="config-block-title">Configuration d'algorithme recommandée</span>
              </div>
              <div class="platforms-grid">
                <div v-if="simulationConfig.twitter_config" class="platform-card">
                  <div class="platform-card-header">
                    <span class="platform-name">Voie 1 : Place / Flux d'information</span>
                  </div>
                  <div class="platform-params">
                    <div class="param-row">
                      <span class="param-label">poids vieillissant</span>
                    ...
                    <div class="param-row">
                      <span class="param-label">Poids de la pertinence</span>
                      <span class="param-value">{{ simulationConfig.twitter_config.relevance_weight }}</span>
                    </div>
                    <div class="param-row">
                      <span class="param-label">seuil viral</span>
                      <span class="param-value">{{ simulationConfig.twitter_config.viral_threshold }}</span>
                    </div>
                    <div class="param-row">
                      <span class="param-label">intensité de la chambre d'écho</span>
                ...
                <div v-if="simulationConfig.reddit_config" class="platform-card">
                  <div class="platform-card-header">
                    <span class="platform-name">Plateforme 2 : Sujets / Communautés</span>
                  </div>
                  <div class="platform-params">
                    <div class="param-row">
                      <span class="param-label">poids vieillissant</span>
      ...
      <div class="step-card" :class="{ 'active': phase === 3, 'completed': phase > 3 }">
        <div class="card-header">
          <div class="step-info">
            ...
            <span class="step-title">Orchestration de l'activation initiale</span>
          </div>
          <div class="step-status">
            <span v-if="phase > 3" class="badge success">Complété</span>
            <span v-else-if="phase === 3" class="badge processing">Organiser</span>
            <span v-else class="badge pending">attendez</span>
          </div>
        </div>
        <div class="card-content">
      ...
      <div class="step-card" :class="{ 'active': phase === 4 }">
        <div class="card-header">
          <div class="step-info">
            ...
            <span class="step-title">Prêt à compléter</span>
          </div>
          <div class="step-status">
              ...
              <div v-else class="rounds-content auto" key="auto">
                <div class="auto-info-card">
                  ...
                  <div class="auto-content">
                    ...
                    <div class="auto-desc">
                      <p class="highlight-tip" @click="useCustomRounds = true">Si vous exécutez ce programme pour la première fois, il est fortement recommandé de passer en « Mode personnalisé » afin de réduire le nombre de simulations, ce qui permet d’obtenir un aperçu rapide des résultats et de réduire le risque d’erreurs.
➝</p>
                    </div>
                  </div>
                </div>
      ...
      <div v-if="selectedProfile" class="profile-modal-overlay" @click.self="selectedProfile = null">
        ...
        <div class="modal-body">
          ...
          <div class="modal-info-grid">
            ...
            <div class="info-item">
              <span class="info-label">Surface d'événement MBTI</span>
          ...
          <div class="modal-section" v-if="selectedProfile.persona">
            ...
            <div class="persona-dimensions">
              <div class="dimension-card">
                ...
                <span class="dim-desc">Trajectoire comportementale complète lors de cet événement</span>
              </div>
              <div class="dimension-card">
                <span class="dim-title">Profilage des schémas comportementaux</span>
                <span class="dim-desc">Résumé de l'expérience et préférences en matière de style de comportement</span>
              </div>
              <div class="dimension-card">
                <span class="dim-title">Empreinte mémoire unique</span>
                <span class="dim-desc">Des souvenirs formés à partir de vraies graines</span>
              </div>
              <div class="dimension-card">
                <span class="dim-title">réseau social</span>
